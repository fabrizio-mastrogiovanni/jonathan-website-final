...
const tiers: Tier[] = [
  ...
  },
  {
    ...
    nameEn: "Diamond",
    nameEs: "Diamante",
    badge: "2×1 · THE BEST OF ALL SERVICES",
    badgeEs: "2×1 · El mejor de todos mis servicios",
    price: "$1,499",
    durationEn: "VALID FOR 1 YEAR",
    durationEs: "Válida por 1 año",
    benefits: [
      ...
      {
        en: "NEO Chatbot: 250 credits included first month",
        es: "Chatbot NEO: 250 créditos incluidos el primer mes",
      },
    ],
    ctaEn: "GET DIAMOND →",
