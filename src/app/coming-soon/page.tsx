  ...
  return (
    <main className="relative flex min-h-screen flex-col bg-paper text-ink">
          ...
          <div className="mx-auto mt-16 max-w-xl">
            <FadeUp delay={1.0}>
              <p className="text-[16px] leading-[1.55] tracking-tight text-ink md:text-[18px]">
                Your credit decides what you pay for your next car. NEO Credit
                Repair Advisor is launching soon — a neural AI advisor that
                cleans, rebuilds, and maximizes your credit profile before you
                walk into a dealership.
              </p>
              <p className="mt-4 text-[13px] italic leading-[1.55] tracking-tight text-muted md:text-[14px]">
                Tu crédito decide cuánto pagas por tu próximo auto. NEO Credit
                Repair Advisor está por llegar — un asesor neuronal con IA que
                limpia, reconstruye y maximiza tu perfil crediticio antes de
                que entres a un dealer.
              </p>
            </FadeUp>
          </div>
      ...
      <div className="border-t border-rule px-6 py-6 text-center font-mono text-[10px] tracking-[0.3em] text-muted md:px-10">
        <span>© 2026 — JONATHAN LÓPEZ · NEO NEGOTIATOR</span>
      </div>
    </main>
  );
}
